...
const MainLayout = () => {
 ...
 { name: 'Groups', href: `${orgPrefix}/groups`, icon: UsersRound },
  ...
  { name: 'Test Takers', href: `${orgPrefix}/test-takers`, icon: Send },
   ...
   { name: 'Resources', href: `${orgPrefix}/resources`, icon: BookOpen },
  ...(isAdmin ? [{ name: 'Credit Requests', href: `${orgPrefix}/credits`, icon: CreditCard }] : []),
 ...
 if (isTestPage) {
    return (
      <div className="min-h-screen bg-gray-50 flex flex-col">
        <main className="flex-auto w-full relative">
          <Outlet />
        </main>
      </div>
    );
